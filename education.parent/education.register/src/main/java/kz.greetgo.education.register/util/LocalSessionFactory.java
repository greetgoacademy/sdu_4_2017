package kz.greetgo.education.register.util;
...
public abstract class LocalSessionFactory implements BeanReplacer, HasAfterInject, DataSourceGetter {
  ...
  @Bean
  public JdbcEducation getJdbcEducation() {
    return jdbcSandbox;
  }

  private JdbcEducation jdbcSandbox = null;
  ...
  public void afterInject() throws Exception {
    ...
    jdbcSandbox = new JdbcEducation(dataSource, transactionManager);
